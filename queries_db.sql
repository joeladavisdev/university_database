...
FROM grades g
JOIN student AS s ON s.student_id = g.student_id
JOIN course AS c ON c.course_offering_id = g.course_offering_id AND c.teacher_id = g.teacher_id
JOIN course_offering AS co ON c.course_offering_id = co.course_offering_id
...
SELECT s.student_name, co.course_name, t.teacher_name
FROM grades g
JOIN student AS s ON s.student_id = g.student_id
JOIN course_offering AS co ON g.course_offering_id = co.course_offering_id
JOIN teacher AS t ON t.teacher_id = g.teacher_id
...
# Most courses in common among teachers and students (Full list):
...
SELECT * FROM student;
SELECT * FROM teacher;
SELECT * FROM course_offering ORDER BY course_offering_id ASC;
SELECT * FROM course;
SELECT * FROM grades;